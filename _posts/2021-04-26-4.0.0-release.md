...
Since the 3.0.0 release, Yibo Cai has been invited as a committer to Arrow,
...
but [Bintray will no longer be available on 2021-05-01][5]. They are provided
by Artifactory now. Users needs to change install instructions because URL
is changed. See [the install document][6] for new instructions. Here is a
...
* And usage and API documentation were added (ARROW-11677).

### Files and filesystems

Some rare instances of GZip files could not be read properly (ARROW-12169).
