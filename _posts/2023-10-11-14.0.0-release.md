...
ensuring mutual compatibility. (GH-37537).
...
have been added (GH-36488), together with an experimental API for device synchronization
(GH-36103).
...
could be executed on platforms without BMI2 support, leading to crashes (GH-37017).
...
New features:
* Allow type promotion added on `pyarrow.concat_tables` [GH-36845](https://github.com/apache/arrow/issues/36845)
