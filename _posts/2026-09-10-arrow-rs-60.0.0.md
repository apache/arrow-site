...
run-end encoded arrays ([#10325]), boolean and null buffers ([#10813]), and faster
...
and sped up plain Parquet string column reads into dictionary arrays ([#10614]).
...
precision checks ([#10998]), general decimal-from-string optimizations ([#10668]),
...
across `concat_elements`, `take_run`, `substring`, and other kernels ([#10629]-[#10634]).
