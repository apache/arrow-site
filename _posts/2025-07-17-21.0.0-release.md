...
The C# Arrow implementation is being extracted from the [Arrow monorepo](https://github.com/apache/arrow) into a standalone repository to allow it to have its own release cadence. See [the mailing list](https://lists.apache.org/thread/0vj7hlzbzrv0lcrm92tgtfdh9gsj4dqb) for more information. This is the final release of the Arrow monorepo that will include the the C# implementation.
