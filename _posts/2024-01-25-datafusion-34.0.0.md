...
DataFusion over the last 6 months and previews where we are heading. You can
...
[ClickBench] queries as shown below.
...
<figure style="text-align: center;">
  ...
  <figcaption>
    <b>Figure 1</b>: Performance improvement between DataFusion 25.0.0 and DataFusion 34.0.0 on ClickBench. 
...
Here are some of the specific enhancements we have made to improve performance:
...
For example, to write to a local file, you can use use the [`CREATE EXTERNAL TABLE` statement]:
...
evaluating DataFusion for their needs understands it better.
