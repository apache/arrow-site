...
This release adds additional improvements to the dyplr interface, to CSV support and to the C-Data interface to exchange data with other languages. For more details, see the [complete R changelog](https://arrow.apache.org/docs/r/news/).
