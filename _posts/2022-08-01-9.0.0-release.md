...
[ARROW-15590](https://issues.apache.org/jira/browse/ARROW-15590), ARROW-15901, ARROW-16657, ARROW-15591).
...
* [ARROW-16371: [JS] Fix error iterating tables with no batches](https://github.com/apache/arrow/pull/13287)
* [ARROW-16704: [JS] Handle case where `tableFromIPC` input is an async `RecordBatchReader`](https://github.com/apache/arrow/pull/13278)
