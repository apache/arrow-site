...
# Apache Arrow 5.0.0 (28 July 2021)
...
This release includes      523 commits from       69 distinct contributors.

```console
$ git shortlog -sn apache-arrow-4.0.0..apache-arrow-5.0.0
    77	David Li
    42	Antoine Pitrou
    41	Krisztián Szűcs
    33	Nic Crane
...
```console
$ git shortlog -csn apache-arrow-4.0.0..apache-arrow-5.0.0
    96	Antoine Pitrou
    69	Sutou Kouhei
    63	David Li
    57	Krisztián Szűcs
