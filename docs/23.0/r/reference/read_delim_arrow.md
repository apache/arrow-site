...
- schema:
  ...
  that describes the table. If provided, it will be used to satisfy both
...
- "T":
  [`timestamp(unit = "ns")`](https://arrow.apache.org/docs/r/reference/data-type.md)

- "t":
  [`time32()`](https://arrow.apache.org/docs/r/reference/data-type.md)
  (The `unit` arg is set to the default value `"ms"`)
...
[`null()`](https://arrow.apache.org/docs/r/reference/data-type.md) type
will be dropped.
