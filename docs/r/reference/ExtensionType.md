...
- `$storage_id()`: Returns the
  [Type](https://arrow.apache.org/docs/r/reference/enums.md) identifier
  corresponding to the `$storage_type()`.

- `$extension_name()`: Returns the extension name.

- `$extension_metadata()`: Returns the serialized version of the
  extension metadata as a [`raw()`](https://rdrr.io/r/base/raw.html)
  vector.
...
- `$WrapArray(array)`: Wraps a storage
  [Array](https://arrow.apache.org/docs/r/reference/array-class.md) into
  an
...
- `$deserialize_instance()`: This method is called when a new
  ...
  validating the serialized extension_metadata (a
  [`raw()`](https://rdrr.io/r/base/raw.html) vector) such that its
  contents can be inspected by fields and/or methods of the R6
  ExtensionType subclass. Implementations must also check the
...
- `$as_vector(extension_array)`: Convert an
  ...
  to an R vector. This method is called by
  [`as.vector()`](https://rdrr.io/r/base/vector.html) on
  [ExtensionArray](https://arrow.apache.org/docs/r/reference/ExtensionArray.md)
  objects, when a
  ...
  [ExtensionArray](https://arrow.apache.org/docs/r/reference/ExtensionArray.md)
  is converted to a
  [`data.frame()`](https://rdrr.io/r/base/data.frame.html), or when a
  [ChunkedArray](https://arrow.apache.org/docs/r/reference/ChunkedArray-class.md)
  (e.g., a column in a
  [Table](https://arrow.apache.org/docs/r/reference/Table-class.md)) is
  converted to an R vector. The default method returns the converted
  storage array.
